<?php
 ...
 $profile = "SELECT PRENOM, NOM , ID_UTILISATEUR, EMAIL, BIRTHDAY, SIGNUPDATE, USERNAME, ifnull(MAX(NUM_FACTURE),'NO FACTURES') AS RECENT,PASSWORD,COUNT(NUM_FACTURE) FROM FACTURE RIGHT JOIN UTILISATEUR USING(ID_UTILISATEUR) WHERE ID_UTILISATEUR = :user;";
